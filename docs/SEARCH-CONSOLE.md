...
| 項目 | 値 |
|------|-----|
| サイト（URL プレフィックス） | `https://rhcpgtbd0611-moto.github.io/daily-three/` |
| サイトマップ | `https://rhcpgtbd0611-moto.github.io/daily-three/sitemap-index.xml` |
| robots.txt | `https://rhcpgtbd0611-moto.github.io/daily-three/robots.txt` |
...
3. 次をそのまま入力（末尾スラッシュあり推奨）:
   ...
   `https://rhcpgtbd0611-moto.github.io/daily-three/`
...
3. `main` に push し、Pages がデプロイされたあと、ブラウザで次が **200** で開けるか確認:
   ...
   `https://rhcpgtbd0611-moto.github.io/daily-three/googlexxxxx.html`
...
- https://rhcpgtbd0611-moto.github.io/daily-three/robots.txt
- https://rhcpgtbd0611-moto.github.io/daily-three/sitemap-index.xml
