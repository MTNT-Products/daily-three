...
export const ui = {
  ja: {
    ...
    subscribeFooterLead: '平日の digest をメールで受け取る（無料）',
    subscribeFooterButton: '購読する',
    subscribeEmailLabel: 'メールアドレス',
    subscribeEmailPlaceholder: 'you@example.com',
    subscribeConsent: 'ダイジェストメールの受信に同意する',
    subscribeSuccess: '登録しました。次回の digest から届きます。',
    subscribeSuccessTitle: '購読の登録が完了しました',
    subscribeSuccessHint: '次回の平日 digest から、このメールアドレスにお届けします。',
    subscribeInvalidEmail: 'メールアドレスを確認してください。',
    subscribeUnavailable: 'いまは登録できません。しばらくしてからお試しください。',
    subscribeFailed: '登録に失敗しました。しばらくしてからお試しください。',
    subscribeSubmitting: '送信中…',
    subscribeConsentRequired: '同意にチェックを入れてから購読してください。',
    subscribeRegisterAnother: '別のメールで登録する',
    langSwitcherAria: '言語',
    langJa: '日本語',
    langEn: 'English',
  ...
  en: {
    ...
    subscribeFooterLead: 'Get weekday digests by email (free)',
    subscribeFooterButton: 'Subscribe',
    subscribeEmailLabel: 'Email address',
    subscribeEmailPlaceholder: 'you@example.com',
    subscribeConsent: 'I agree to receive weekday digest emails',
    subscribeSuccess: "You're subscribed. You'll get the next weekday digest.",
    subscribeSuccessTitle: "You're subscribed",
    subscribeSuccessHint: "We'll send the next weekday digest to this address.",
    subscribeInvalidEmail: 'Please check your email address.',
    subscribeUnavailable: 'Sign-up is unavailable right now. Please try again later.',
    subscribeFailed: 'Could not subscribe. Please try again later.',
    subscribeSubmitting: 'Sending…',
    subscribeConsentRequired: 'Please check the consent box before subscribing.',
    subscribeRegisterAnother: 'Use a different email',
